...
no_dist = False
no_pretrain = True
note = 'dataset: cifar100 | model: deit_tiny_patch4_32 | output_dir: ./runs/__exp__/cifar100/deit_tiny_patch4_32/gelu'
num_workers = 8
optimizer = 'adamw'
output_dir = './runs/__exp__/cifar100/deit_tiny_patch4_32/gelu'
