...
no_dist = False
no_pretrain = True
note = 'dataset: cifar10 | model: deit_tiny_patch4_32 | output_dir: ./runs/__exp__/cifar10/deit_tiny_patch4_32/gelu'
num_workers = 8
optimizer = 'adamw'
output_dir = './runs/__exp__/cifar10/deit_tiny_patch4_32/gelu'
